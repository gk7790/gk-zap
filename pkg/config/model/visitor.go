...
func (c *XTCPVisitorConfig) Complete(g *ClientCommonConfig) {
	...
	c.Protocol = value.EmptyOr(c.Protocol, "quic")
	c.MaxRetriesAnHour = value.EmptyOr(c.MaxRetriesAnHour, 8)
	c.MinRetryInterval = value.EmptyOr(c.MinRetryInterval, 90)
	c.FallbackTimeoutMs = value.EmptyOr(c.FallbackTimeoutMs, 1000)
